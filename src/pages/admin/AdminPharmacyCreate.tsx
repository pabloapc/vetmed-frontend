...
export const AdminPharmacyCreate: React.FC = () => {
    ...
    const handleSubmit = async (e?: React.FormEvent) => {
        ...
        try {
            ...
            await adminService.createPharmacy(payload);
            ...
            <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 px-6 pt-10 pb-8">
                <div className="mx-auto max-w-2xl">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-white">Nueva farmacia</h1>
                            <p className="text-sm text-slate-300">Completá los datos para registrar la farmacia</p>
                        </div>
                    </div>
                </div>
            </div>
...
export default AdminPharmacyCreate;
