...
export const AdminDoctorEdit: React.FC = () => {
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                setLoading(true);
                const res = await adminService.getDoctor(id);
    ...
    const handleSave = async (e?: React.FormEvent) => {
        ...
        try {
            ...
            await adminService.updateDoctor(id, payload);
    ...
    return (
        <div className="container mx-auto p-6 max-w-2xl">
            <h2 className="text-xl font-semibold mb-4">Editar Doctor</h2>
