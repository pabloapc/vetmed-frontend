...
export const AdminPharmacyEdit: React.FC = () => {
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                setLoading(true);
                const res = await adminService.getPharmacy(id);
    ...
    const handleSave = async (e?: React.FormEvent) => {
        ...
        try {
            ...
            await adminService.updatePharmacy(id, payload);

            // 2) Upload vademecum file using dedicated endpoint
            if (vademecumFile) {
                try {
                    await adminService.uploadPharmacyVademecumFile(
                        id,
                        vademecumFile
                    );
                } catch (uploadErr: any) {
                    ...
                    setError(
                        `${msg} (la farmacia sí se actualizó, pero faltó el archivo)`
                    );
                    return;
                }
            }
            alert("Farmacia actualizada");
            ...
            <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 px-6 pt-10 pb-8">
                <div className="mx-auto max-w-2xl">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-white">Editar Farmacia</h1>
...
export default AdminPharmacyEdit;
