...
export const AdminPrestations: React.FC = () => {
    ...
    const load = async () => {
        setLoading(true);
        try {
            const res: any = await adminService.listPrestations({
                page,
                limit,
                q,
            });
            ...
            console.error("admin prestations list error", err);
            setItems([]);
        } finally {
            setLoading(false);
        }
    ...
    const handleDelete = async (id: string) => {
        if (!confirm("¿Eliminar prestación? Esta acción es irreversible."))
            return;
        try {
            ...
            console.error(err);
            alert("No se pudo eliminar la prestación");
        }
    };
    ...
    return (
        <div className="container mx-auto p-6">
            <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-semibold">Prestaciones</h2>
                <div>
                    <button
