...
const ACTION_TYPES = [
    { value: "medicamento", label: "Consulta de medicamento" },
    { value: "descuento", label: "Descuento / beneficio" },
...
export const PharmacyDetail: React.FC = () => {
    ...
    // request form
    const [actionType, setActionType] = useState("medicamento");
    ...
    const buildMapsUrl = () => {
        if (!pharmacy) return "https://www.google.com/maps";
        const lat = pharmacy.coordinates?.latitude;
        const lng = pharmacy.coordinates?.longitude;
        if (lat && lng)
        ...
        return (
            <div className="container mx-auto px-4 py-12 text-center max-w-md">
                ...
                <h2 className="text-lg font-semibold text-gray-900 mb-2">
                    Iniciá sesión para ver esta farmacia
                </h2>
    ...
    if (error || !pharmacy)
        return (
            <div className="container mx-auto px-4 py-12 text-center">
                ...
                <p className="text-gray-600">{error || "Farmacia no encontrada"}</p>
                <button
                    onClick={() => navigate(-1)}
        ...
        <div className="container mx-auto px-4 py-10 max-w-3xl">
            ...
            <div className="bg-white rounded-xl shadow p-6">
                ...
                <p className="text-sm text-gray-500 mb-4">
                    {isAuthenticated
                        ? "Enviá tu consulta directamente a la farmacia."
